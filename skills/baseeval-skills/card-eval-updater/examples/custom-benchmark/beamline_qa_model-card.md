...
**beamline_qa** — 24 four-way multiple-choice questions on synchrotron light-source science: accelerator physics, beamline optics, and X-ray techniques. Correct-answer positions were shuffled with a fixed seed, so the majority-position baseline is 8/24.
...
- **Random seeds**: 0, 1234
- **Evaluation runtime**: 6s
- **Artifacts**: `examples/custom-benchmark/results/beamline_qa`
